  ...
  return (
    <>
      ...
      <section className="py-16 lg:py-20 bg-cream">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-display text-charcoal mb-4 text-center">
            2026 Discovery Sport Trim Comparison
          </h2>
          <p className="text-slate text-center mb-10 max-w-2xl mx-auto">
            Compare specifications and standard equipment across all 2026 Discovery Sport trim levels. P300e PHEV available from S trim upward.
          </p>
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b-2 border-sand/40">
                  ...
                  <th className="text-center py-4 px-3 text-xs uppercase tracking-wider text-slate font-semibold min-w-[120px]">Discovery Sport</th>
              ...
              <tbody>
                <tr className="border-b-2 border-sand/30 bg-racing-green/5">
                  ...
                  <td className="py-4 px-3 text-center font-bold text-sand">£36,000</td>
                  <td className="py-4 px-3 text-center font-bold text-sand">£38,500</td>
                  <td className="py-4 px-3 text-center font-bold text-sand">£41,500</td>
                  <td className="py-4 px-3 text-center font-bold text-sand">£45,000</td>
                  <td className="py-4 px-3 text-center font-bold text-sand">£49,000</td>
                </tr>
                <tr className="border-b border-sand/20">
                  <td className="py-3 px-4 text-sm text-charcoal font-medium">18" Alloy Wheels</td>
                  <td className="py-3 px-3 text-center text-sm text-charcoal">17"</td>
                ...
                <tr className="border-b border-sand/20 bg-white/50">
                  <td className="py-3 px-4 text-sm text-charcoal font-medium">5+2 Seating</td>
                ...
                <tr className="border-b border-sand/20">
                  <td className="py-3 px-4 text-sm text-charcoal font-medium">Cloth / Leather Interior</td>
                  <td className="py-3 px-3 text-center text-sm text-charcoal">Cloth</td>
                ...
                <tr className="border-b border-sand/20 bg-white/50">
                  <td className="py-3 px-4 text-sm text-charcoal font-medium">Terrain Response</td>
                  <td className="py-3 px-3 text-center text-sand text-lg">&#10003;</td>
                  <td className="py-3 px-3 text-center text-sand text-lg">&#10003;</td>
                  <td className="py-3 px-3 text-center text-sand text-lg">&#10003;</td>
                  <td className="py-3 px-3 text-center text-sm text-charcoal">TR2</td>
                  <td className="py-3 px-3 text-center text-sm text-charcoal">TR2</td>
                </tr>
                <tr className="border-b border-sand/20">
      ...
      <section className="py-16 lg:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-display text-charcoal mb-4 text-center">
            What the Experts Say About the 2026 Discovery Sport
          </h2>
          <p className="text-slate text-center mb-10 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-cream rounded-xl p-6 border border-sand/30">
              ...
              <p className="text-slate text-sm leading-relaxed mb-4">
                &ldquo;The P270e PHEV's refinement is impressive. Road roar is very well contained in all versions, making it a comfortable family companion.&rdquo;
              </p>
              <a
                href="https://www.whatcar.com/land-rover/discovery-sport/4x4/review/"
                target="_blank"
            ...
            <div className="bg-cream rounded-xl p-6 border border-sand/30">
              ...
              <p className="text-slate text-sm leading-relaxed mb-4">
                &ldquo;Strong practicality, comfort and refinement remain. After the latest facelift, it remains a competitive, practical and overtly premium family SUV.&rdquo;
              </p>
              <a
                href="https://www.autocar.co.uk/car-review/land-rover/discovery-sport"
                target="_blank"
                rel="noopener noreferrer"
                className="text-sand text-sm font-semibold hover:underline"
              >
            ...
            <div className="bg-cream rounded-xl p-6 border border-sand/30">
              ...
              <p className="text-slate text-sm leading-relaxed mb-4">
                &ldquo;A good all-rounder with the practicality of 5+2 seating in a compact package. The PHEV model stands out for company car drivers with low BIK rates.&rdquo;
              </p>
              <a
                href="https://www.carwow.co.uk/land-rover/discovery-sport"
                target="_blank"
                rel="noopener noreferrer"
                className="text-sand text-sm font-semibold hover:underline"
              >
      ...
      <section className="py-16 lg:py-20 bg-cream">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <a
              href="https://www.youtube.com/results?search_query=carwow+discovery+sport+review+2024"
              target="_blank"
              rel="noopener noreferrer"
            ...
            >
              ...
              <div>
                <p className="text-charcoal font-semibold group-hover:text-sand transition-colors">Discovery Sport Full Review</p>
                <p className="text-slate text-sm">Carwow</p>
              </div>
            </a>
            <a
              href="https://www.youtube.com/results?search_query=what+car+discovery+sport+review+2024"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-4 bg-cream rounded-xl p-5 border border-sand/30 hover:border-sand transition-colors group"
            >
              ...
              <div>
                <p className="text-charcoal font-semibold group-hover:text-sand transition-colors">Discovery Sport Road Test</p>
